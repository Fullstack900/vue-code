...
export class AttendanceService {
  ...
  private hrCorrectionStatus = new BehaviorSubject<any>("");
  hrCorrectionStatusMetaData= this.hrCorrectionStatus.asObservable();
  ...
  setHrCorrectionStatusMetaData(metaData:any){
    this.hrCorrectionStatus.next(metaData);
  }
